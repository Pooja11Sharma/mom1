                    ...
                    <table class="table">
                      <thead class="black white-text">
                        <tr>
                          ...
                          <th scope="col">Employee Start_Date</th>
                      ...
                      <tbody>
                        <tr>
                          <td id="delid"  name="emp_id" data-title="Employee ID">
                          ...
                          <td  style="text-align:center;" data-title="Employee Status">
                            <%=i.getEmp_status()%>
                          </td>
                          <td  style="text-align:center;" data-title="Employee Start_Date">
                          <%=i.getEmp_startdate()%>
                          </td>
                          <td style="text-align:center;" data-title=" Edit Employee">
                          <a class="btn btn-primary" href="UpdateEmployee.jsp?id=<%=i.getEmp_id()%>">Edit</a>
                          </td>
                          <td   style="text-align:center;" data-title="Deactivate">
                          <a class="deactive-employee btn btn-primary " href="DeactivateEmployee?id=<%=i.getEmp_id() %>">Deactivate</a>
                          </td>
                        </tr>
                        <%
                      }
